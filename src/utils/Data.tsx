...
export const skills = [
  ...
  { name: "Oracle Database", icon: "/icons/oradb.svg" },
  { name: "HTML", icon: "/icons/html5.svg" },
  { name: "CSS", icon: "/icons/css.svg" },
  { name: "Tailwind CSS", icon: "/icons/tcss.svg" },
  { name: "JavaScript", icon: "/icons/js.svg" },
  { name: "TypeScript", icon: "/icons/tjs.svg" },
  { name: "React JS", icon: "/icons/react.svg" },
  { name: "Vue JS", icon: "/icons/vue.svg" },
  { name: "Node JS", icon: "/icons/node.svg" },
  { name: "JSON", icon: "/icons/json.svg" },
  { name: "C", icon: "/icons/C.svg" },
  { name: "Microservices", icon: "/icons/mcs.svg" },
  ...
  { name: "Artificial Intelligence", icon: "/icons/ai.svg" },
  { name: "Streamlit", icon: "/icons/streamlit.svg" },
  { name: "Software Engineering", icon: "/icons/se.svg" },
  { name: "Software Testing", icon: "/icons/st.svg" },
  { name: "Data Structure and Algorithms", icon: "/icons/dsa.svg" },
];